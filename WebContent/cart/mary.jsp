...
<script src="${pageContext.request.contextPath}/assets/js/jquery-3.5.0.min.js"></script>
    ...
    <script src="${pageContext.request.contextPath}/assets/js/mary.js"></script>
...
<input type="hidden" value="${sessionId}" id="admin_check"> <!-- 관리자인지 아닌지 체크 후 관리자메뉴 show -->
   ...
   <!--메리제인서브화면-->
    ...
    <div class="product">
        <h1><a href="${pageContext.request.contextPath}/app/board/mary.jsp">메리제인</a></h1>
        <ul class="p-n">
    ...
    <div class="product-1">
        <ul>
            <li class="pn1"><a href=#><img src="${pageContext.request.contextPath}/assets/images/mary-janes/mary-janes1.jpg" alt="블랙스웨이트카프스킨"></a></li>
            <li class="pn2" id="new"><a href="#"><img src="${pageContext.request.contextPath}/assets/images/mary-janes/mary-janes2.jpg" alt="그레이스웨이드카프스킨"></a></li>
            <li class="pn3"><a href="#"><img src="${pageContext.request.contextPath}/assets/images/mary-janes/mary-janes3.jpg" alt="베이지램스킨"></a></li>
        </ul>
        <div class="text1">
            <ul class="t-1">
                <li><a href="#">스웨이드 카프스킨</a></li>
                <li><a href="#">스웨이드 카프스킨</a></li>
                <li><a href="#">램스킨</a></li>
            </ul>
            <ul class="t-2">
    ...
    <div class="product-2">
        <ul>
            <li class="pn4"><a href="#"><img src="${pageContext.request.contextPath}/assets/images/mary-janes/mary-janes4.jpg" alt="진한그레이스웨이드카프스킨"></a></li>
            <li class="pn5"><a href="#"><img src="${pageContext.request.contextPath}/assets/images/mary-janes/mary-janes5.jpg" alt="블랙시퀸"></a></li>
            <li class="pn6"><a href="#"><img src="${pageContext.request.contextPath}/assets/images/mary-janes/mary-janes6.jpg" alt="그레이시퀸"></a></li>
    ...
    <div class="productpage-wrap wrap1" style="display: none">
        ...
        <ul>
            ...
            <li class="p-1"><a href="#">
                    <img src="${pageContext.request.contextPath}/assets/images/mary-janes/mary-janes1.jpg" alt="상품메인">
                </a></li>
        </ul>
          <ul class="p-1-1">
            <li>스웨이드 카프스킨</li>
        ...
        <ul class="p-s1">
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/mary-janes/maryjane1-2.jpg" alt=""></a>
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/mary-janes/maryjane1-3.jpg" alt=""></a>
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/mary-janes/maryjane1-4.jpg" alt=""></a>
        </ul>
		...
		<div class="option_wrap">
				<form action="write2.do" method="post" class="cart_go">
    ...
    <div class="productpage-wrap wrap2"  style="display: none">
        <ul>
            ...
            <li class="p-1"><a href="#">
                    <img src="${pageContext.request.contextPath}/assets/images/mary-janes/mary-janes2.jpg" alt="상품메인">
                </a></li>
        </ul>
        <ul class="p-1-1">
            <li>스웨이드 카프스킨</li>
        ...
        <ul class="p-s1">
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/mary-janes/maryjane2-2.jpg" alt=""></a>
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/mary-janes/maryjane2-3.jpg" alt=""></a>
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/mary-janes/maryjane2-4.jpg" alt=""></a>
        </ul>
...
<!--				구매버튼-->
    ...
    <div class="productpage-wrap wrap3"  style="display: none">
        <ul>
            ...
            <li class="p-1"><a href="#">
                    <img src="${pageContext.request.contextPath}/assets/images/mary-janes/mary-janes3.jpg" alt="상품메인">
                </a></li>
        </ul>
           <ul class="p-1-1">
            <li>램스킨</li>
        ...
        <!--            상품작은이미지상단-->
         ...
         <ul class="p-s1">
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/mary-janes/maryjane3-2.jpg" alt=""></a>
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/mary-janes/maryjane3-3.jpg" alt=""></a>
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/mary-janes/maryjane3-4.jpg" alt=""></a>
        </ul>
...
<!--				구매버튼-->
    ...
    <div class="productpage-wrap wrap4"  style="display: none">
        <ul>
            ...
            <li class="p-1"><a href="#">
                    <img src="${pageContext.request.contextPath}/assets/images/mary-janes/mary-janes4.jpg" alt="상품메인">
                </a></li>
        </ul>
        <ul class="p-1-1">
            <li>스웨이드 카프스킨</li>
        ...
        <!--            상품작은이미지상단-->
         ...
         <ul class="p-s1">
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/mary-janes/maryjane4-2.jpg" alt=""></a>
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/mary-janes/maryjane4-3.jpg" alt=""></a>
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/mary-janes/maryjane4-4.jpg" alt=""></a>
        </ul>
...
<!--				구매버튼-->
    ...
    <div class="productpage-wrap wrap5"  style="display: none">
        <ul>
            ...
            <li class="p-1"><a href="#">
                    <img src="${pageContext.request.contextPath}/assets/images/mary-janes/mary-janes5.jpg" alt="상품메인">
                </a></li>
        </ul>
        <ul class="p-1-1">
            <li>시퀸</li>
        ...
        <ul class="p-s1">
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/mary-janes/maryjane5-2.jpg" alt=""></a>
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/mary-janes/maryjane5-3.jpg" alt=""></a>
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/mary-janes/maryjane5-4.jpg" alt=""></a>
        </ul>
      ...
      <div class="button1">
		...
		<div class="option_wrap">
            <form action="write2.do" method="post" class="cart_go">
				<table style="display:none;">
					<tr>
						<td>가격<input type="text" value="1570000" class="cPrice"></td>
					</tr>
					<tr>
						<td>전체가격<input type="text" name="cPriceAll" value="1570000" class="cPriceAll"></td>
					</tr>
					<tr>
						<td>상품id<input type="text" name="sId" class="sId"></td>
					</tr>
...
<!--				구매버튼-->
    ...
    <div class="productpage-wrap wrap6"  style="display: none">
        <ul>
            ...
            <li class="p-1"><a href="#">
                    <img src="${pageContext.request.contextPath}/assets/images/mary-janes/mary-janes6.jpg" alt="상품메인">
                </a></li>
        </ul>
       <ul class="p-1-1">
            <li>시퀸</li>
       ...
       <ul class="p-s1">
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/mary-janes/maryjane6-2.jpg" alt=""></a>
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/mary-janes/maryjanes6-3.jpg" alt=""></a>
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/mary-janes/maryjanes6-4.jpg" alt=""></a>
        </ul>
