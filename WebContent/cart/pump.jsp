...
<script src="${pageContext.request.contextPath}/assets/js/jquery-3.5.0.min.js"></script>
    ...
    <script src="${pageContext.request.contextPath}/assets/js/pump.js"></script>
...
<input type="hidden" value="${sessionId}" id="admin_check"> <!-- 관리자인지 아닌지 체크 후 관리자메뉴 show -->
   ...
   <!--메리제인서브화면-->
    ...
    <div class="product-1">
        <ul>
            <li class="pn1"><a href="#"><img src="${pageContext.request.contextPath}/assets/images/pump/pumps1.jpg" alt="베이지 램스킨"></a></li>
            <li class="pn2"><a href="#"><img src="${pageContext.request.contextPath}/assets/images/pump/pumps2.jpg" alt="블랙 트위드"></a></li>
            <li class="pn3"><a href="#"><img src="${pageContext.request.contextPath}/assets/images/pump/pumps3.jpg" alt="블랙 별 실크 크레이프"></a></li>
        </ul>
        <div class="text1">
            <ul class="t-1">
                <li><a href="#">램스킨</a></li>
                <li><a href="#">트위드</a></li>
                <li><a href="#">실크 크레이프</a></li>
            </ul>
            <ul class="t-2">
                <li><a href="#">₩1,084,000</a></li>
                <li><a href="#">₩1,208,000</a></li>
                <li><a href="#">₩1,853,000</a></li>
            </ul>
        </div>
    </div>
    <div class="product-2">
        <ul>
            <li class="pn4" id="new"><a href="#"><img src="${pageContext.request.contextPath}/assets/images/pump/pumps4.jpg" alt="레드 테이턴트 카프스킨"></a></li>
            <li class="pn5"><a href="#"><img src="${pageContext.request.contextPath}/assets/images/pump/pumps5.jpg" alt="연보라 테이턴트 카프스킨"></a></li>
            <li class="pn6"><a href="#"><img src="${pageContext.request.contextPath}/assets/images/pump/pumps6.jpg" alt="블랙 램스킨"></a></li>

        </ul>
        <div class="text2">
            <ul class="t-3">
                <li><a href="#">테이턴트 카프스킨</a></li>
                <li><a href="#">테이턴트 카프스킨</a></li>
                <li><a href="#">블랙 램스킨</a></li>
            </ul>
            <ul class="t-4">
                <li><a href="#">₩1,292,000</a></li>
                <li><a href="#">₩1,292,000</a></li>
                <li><a href="#">₩1,236,000</a></li>
            </ul>
        </div>
    </div>
      <!--        상품상세페이지1-->
    ...
    <div class="productpage-wrap wrap1" style="display: none">
        ...
        <ul>
            ...
            <li class="p-1"><a href="#">
                    <img src="${pageContext.request.contextPath}/assets/images/pump/pumps1.jpg" alt="상품메인">
                </a></li>
        </ul>
          <ul class="p-1-1">
            <li>램스킨</li>
        ...
        <!--            상품작은이미지상단-->
         ...
         <ul class="p-s1">
            <li><a href="#"><img src="${pageContext.request.contextPath}/assets/images/pump/pumps1-1.jpg" alt=""></a>
            <li><a href="#"><img src="${pageContext.request.contextPath}/assets/images/pump/pumps1-2.jpg" alt=""></a>
            <li><a href="#"><img src="${pageContext.request.contextPath}/assets/images/pump/pumps1-3.jpg" alt=""></a>
        </ul>
		...
		<div class="option_wrap">
				<form action="write4.do" method="post" class="cart_go">
    ...
    <div class="productpage-wrap wrap2"  style="display: none">
        <ul>
            ...
            <li class="p-1"><a href="#">
                    <img src="${pageContext.request.contextPath}/assets/images/pump/pumps2.jpg" alt="상품메인">
                </a></li>
        </ul>
        <ul class="p-1-1">
            <li>트위드</li>
        ...
        <ul class="p-s1">
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/pump/pumps2-1.jpg" alt=""></a>
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/pump/pumps2-2.jpg" alt=""></a>
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/pump/pumps2-3.jpg" alt=""></a>
        </ul>
      ...
      <div class="button1">
		...
		<div class="option_wrap">
            <form action="write4.do" method="post" class="cart_go">
				<table style="display:none;">
					<tr>
						<td>가격<input type="text" value="1208000" class="cPrice"></td>
					</tr>
					<tr>
						<td>전체가격<input type="text" name="cPriceAll" value="1208000" class="cPriceAll"></td>
					</tr>
					<tr>
						<td>상품id<input type="text" name="sId" class="sId"></td>
					</tr>
...
<!--				구매버튼-->
    ...
    <div class="productpage-wrap wrap3"  style="display: none">
        <ul>
            ...
            <li class="p-1"><a href="#">
                    <img src="${pageContext.request.contextPath}/assets/images/pump/pumps3.jpg" alt="상품메인">
                </a></li>
        </ul>
         <ul class="p-1-1">
            <li>실크 크레이프</li>
       ...
       <ul class="p-s1">
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/pump/pumps3-1.jpg" alt=""></a>
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/pump/pumps3-2.jpg" alt=""></a>
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/pump/pumps3-3.jpg" alt=""></a>
        </ul>
      ...
      <div class="button1">
		...
		<div class="option_wrap">
            <form action="write4.do" method="post" class="cart_go">
				<table style="display:none;">
					<tr>
						<td>가격<input type="text" value="1853000" class="cPrice"></td>
					</tr>
					<tr>
						<td>전체가격<input type="text" name="cPriceAll" value="1853000" class="cPriceAll"></td>
					</tr>
					<tr>
						<td>상품id<input type="text" name="sId" class="sId"></td>
					</tr>
...
<!--				구매버튼-->
    ...
    <div class="productpage-wrap wrap4"  style="display: none">
        <ul>
            ...
            <li class="p-1"><a href="#">
                    <img src="${pageContext.request.contextPath}/assets/images/pump/pumps4.jpg" alt="상품메인">
                </a></li>
        </ul>
         <ul class="p-1-1">
            <li>테이턴트 카프스킨</li>
    ...
    <ul class="p-s1">
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/pump/pumps4-1.jpg" alt=""></a>
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/pump/pumps4-2.jpg" alt=""></a>
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/pump/pumps4-3.jpg" alt=""></a>
        </ul>
      ...
      <div class="button1">
		...
		<div class="option_wrap">
            <form action="write4.do" method="post" class="cart_go">
				<table style="display:none;">
					<tr>
						<td>가격<input type="text" value="1292000" class="cPrice"></td>
					</tr>
					<tr>
						<td>전체가격<input type="text" name="cPriceAll" value="1292000" class="cPriceAll"></td>
					</tr>
					<tr>
						<td>상품id<input type="text" name="sId" class="sId"></td>
					</tr>
...
<!--				구매버튼-->
    ...
    <div class="productpage-wrap wrap5"  style="display: none">
        <ul>
            ...
            <li class="p-1"><a href="#">
                    <img src="${pageContext.request.contextPath}/assets/images/pump/pumps5.jpg" alt="상품메인">
                </a></li>
        </ul>
        <ul class="p-1-1">
            <li>테이턴트 카프스킨</li>
        ...
        <ul class="p-s1">
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/pump/pumps5-1.jpg" alt=""></a>
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/pump/pumps5-2.jpg" alt=""></a>
            <li><a href=""><img src="${pageContext.request.contextPath}/assets/images/pump/pumps5-3.jpg" alt=""></a>
        </ul>
...
<!--				구매버튼-->
    ...
    <div class="productpage-wrap wrap6"  style="display: none">
        <ul>
            ...
            <li class="p-1"><a href="#">
                    <img src="${pageContext.request.contextPath}/assets/images/pump/pumps6.jpg" alt="상품메인">
                </a></li>
        </ul>
        <ul class="p-1-1">
            <li>램스킨</li>
        ...
        <ul class="p-s1">
            <li><a href="#"><img src="${pageContext.request.contextPath}/assets/images/pump/pumps6-1.jpg" alt=""></a>
            <li><a href="#"><img src="${pageContext.request.contextPath}/assets/images/pump/pumps6-2.jpg" alt=""></a>
            <li><a href="#"><img src="${pageContext.request.contextPath}/assets/images/pump/pumps6-3.jpg" alt=""></a>
        </ul>
      ...
      <div class="button1">
		...
		<div class="option_wrap">
            <form action="write4.do" method="post" class="cart_go">
				<table style="display:none;">
					<tr>
						<td>가격<input type="text" value="1236000" class="cPrice"></td>
					</tr>
					<tr>
						<td>전체가격<input type="text" name="cPriceAll" value="1236000" class="cPriceAll"></td>
					</tr>
					<tr>
						<td>상품id<input type="text" name="sId" class="sId"></td>
					</tr>
