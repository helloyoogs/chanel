...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/order_list.css?after">
...
<input type="hidden" value="${sessionId}" id="admin_check"> <!-- 관리자인지 아닌지 체크 후 관리자메뉴 show -->
	...
	<div class="shop">
		...
		<c:if test="${empty order_list}">
			...
			<p style="line-height: 100px; margin-left: 44.5%;">구매목록이 비어있습니다.</p>
		</c:if>
<div class="shop1">
	<table id="products" border="1">
      ...
      <p  style="display:none;">
		...
		<c:forEach items="${order_list}" var="dto" varStatus="vs">
		<tr>
		<td>
			<div class="product">
				<div class="product2">
