...
<head>
   <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/write_view.css?after">
...
<div class="shop1">
		...
		<table width="500" cellpadding="0" cellspacing="0" border="1">
			...
			<tr>
				<td>상품이미지</td>
				<td><input type="text" name="sImg" size="50"></td>
			</tr>
			<tr>
				<td>상품사이즈</td>
				<td><input type="text" name="sSize" size="50"></td>
			</tr>
			<tr>
				<td>상품가격</td>
				<td><input type="text" name="sPrice" size="50"></td>
			</tr>
			<tr>
				<td>상품재고</td>
				<td><input type="text" name="sStock" size="50"></td>
			</tr>
		<!-- 	<tr>
