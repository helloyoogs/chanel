...
<head>
   <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/list.css?after">
...
<!-- 장바구니 페이지-->
	<div class="shop">
		...
		<c:if test="${empty list}">
			...
			<p style="line-height: 100px; margin-left: 44.5%;">상품목록이 비어있습니다.</p>
		</c:if>
<div class="shop1">
	<table id="products" border="1">
      ...
      <p  style="display:none;">
		...
		<td>
			<div class="product">
				<div class="product2">
					<a href="content_view.do?sId=${dto.sId}"><img alt="구두이미지" src="${dto.sImg}"></a>
					<ul class="p-n-2">
						<li><a href="content_view.do?sId=${dto.sId}">${dto.sId }</a></li>
						<li><a href="content_view.do?sId=${dto.sId}">${dto.sName}</a></li>
						<li>${dto.sSize}</li>
						<li>${dto.sStock}</li>
						<li>${dto.sPrice}</li>
					</ul>
	...
	<!--    리스트하단-->
		<div class="shop-bottom">
			<ul>
				<button class="btn1-1" >
					<a href="${pageContext.request.contextPath}/s_manager/write_view.do">상품등록하기</a>
				</button>
				<button class="btn1-1" >
					<a href="${pageContext.request.contextPath}/s_manager/total_list.do">재고확인</a>
				</button>
			</ul>
		</div>
	<!--	푸터-->
