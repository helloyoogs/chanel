...
<input type="hidden" value="${sessionId}" id="admin_check"> <!-- 관리자인지 아닌지 체크 후 관리자메뉴 show -->
    ...
    <div class="log-wrap">
        <!-- 비밀번호찾기창-->
       <form method="post" action="${pageContext.request.contextPath}/member/MemberFindPwOk.me" name="loginForm">
        <div class="log1">
          <input placeholder="이메일" type="text" class="log1-1" name="memberEmail" id="memberEmail" value="" />
          <input placeholder="아이디" type="text" class="log1-1" name="memberId" id="memberId" value="" />
            <button type="button" class="btn1-1" onclick="check()">비밀번호찾기</button>
        </div>
        </form> 
    </div>
