...
//		req.setAttribute("boardList", dao.getList(startRow, endRow));
		...
		//System.out.println("getBoardlist1");
		req.setAttribute("boardList", dao.getList(skipCount));
		//System.out.println("getBoardlist2");
		forward.setRedirect(false);
		forward.setPath("/app/board/boardList.jsp");
		
		//System.out.println("boardNull!? " + dao.getBoardList());
		//System.out.println("getBoardlist2");
